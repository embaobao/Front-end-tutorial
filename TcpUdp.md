...
- 标识符
  ...
  ![img](./tcpudp/1631bef9e3c60035)

  RTT 指标表示发送端发送数据到接收到对端数据所需的往返时间。

![img](TcpUdp/images/1631bf1e79b3cd42)
...
![img](TcpUdp/images/153245_xKna_12.jpg)[TFO](https://blog.csdn.net/weixin_33975951/article/details/92136586)
...
###![img](TcpUdp/images/1631fb807f2c6c1b)
...
发送端窗口包含已发送但未收到应答的数据和可以发送但是未发送的数据。![img](./tcpudp/1632f25c587ffd54)
...
**滑动窗口是一个![img](TcpUdp/images/1632f25cca99c8f4)很重要的概念，它帮助 TCP 实现了流量控制的功能。接收方通过报文告知发送方还可以发送多少数据，从而保证接收方能够来得及接收数据，防止出现接收方带宽已满，但是发送方还一直发送数据的情况。**
